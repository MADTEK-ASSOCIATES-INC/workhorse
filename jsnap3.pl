...
#
#
# ex: jsnap <production directory> <snapshot directory>
#
#

use Digest::MD5;

die "\nusage: $0 <source directory> <snapshot directory>\n" if $#ARGV < 1;
...
my $snaplogfile = $ARGV[1] . "/jsnap." . time;
my $snapfilename = $ARGV[1] . "/jsnap.txt";

open SFHL, ">$snaplogfile" or die $!;
